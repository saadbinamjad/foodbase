<?php
class Save_burger_model extends CI_Model {
	...
	function save_model(){
		...
		if ( ! $this->upload->do_upload()){
			...
			$data1= array('burger_id'=> $hello,
     		...
     		$this->db->insert('burger_size', $data1);


     		$data2= array('burger_id'=> $hello,
     		...
     		$this->db->insert('burger_calories', $data2);
