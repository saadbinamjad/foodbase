	...
	<body>
		...
		<!-- Header -->
			<section id="header">
				<header>
					<h1>Foodbase</h1>
					<p>The ultimate foodie experience</p>
				</header>
				<footer>
					<a href="#banner" class="button style2 scrolly scrolly-centered">Order Right From Your Table</a>
				</footer>
			</section>
		...
		<!-- Banner -->
			<section id="banner">
				...
				<p>A brand new, simple, yet elegant resturant food ordering solution.<br />
				With few steps, get your desired food right at your table!</p>
				<footer>
					<a href="#first" class="button style2 scrolly">Browse Menu</a>
				</footer>
			</section>
		...
		<!-- Feature 1 -->
			<article id="first" class="container box style1 right">
				...
				<div class="inner">
					...
					<p>From cheese, fish, mushrooms, to usual beef and chicken!</p>
				</div>
			</article>
		...
		<!-- Feature 2 -->
			<article class="container box style1 left">
				...
				<div class="inner">
					...
					<p>From baked, roasted to fried. Get it now!</p>
				</div>
			</article>
		<!-- Feature 3 -->
			<article class="container box style1 right">
				...
				<div class="inner">
					...
					<p>Mushrooms, Beef, Italian...try it now!</p>
				</div>
			</article>
		...
		<!-- Feature 4 -->
			<article class="container box style1 left">
				...
				<div class="inner">
					...
					<p>No more thirst! From chilled to the hottest in town...</p>
				</div>
			</article>
		<!-- Portfolio -->
