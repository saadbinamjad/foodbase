...
<body>
 ...
 <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">Input Chicken Details</h1>
</div> 
    ...
    <?php echo form_open_multipart('save_chicken_data/save', $data);?>
    ...
    <label>Party:</label>
    <?php echo form_input('party');?>
    <br>

    <label>Combo:</label>
    <?php echo form_input('combo');?>
    <br>
