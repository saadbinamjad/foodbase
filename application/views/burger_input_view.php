...
<body>
 ...
 <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">Input Burger Details</h1>
</div> 
    ...
    <?php echo form_open_multipart('save_burger_data/save', $data);?>
    ...
    <label>Kids:</label>
    <?php echo form_input('kids');?>
    <br>

    <label>Single:</label>
    <?php echo form_input('single');?>
    <br>

    <label>Doubles:</label>
    <?php echo form_input('doubles');?>
    <br>
